import { RxListTemplateChanges, RxTemplateSettings } from './model';
 ...
 */
export declare function getTemplateHandler<C extends RxListViewContext<T>, T>(templateSettings: RxTemplateSettings<T, C>): ListTemplateManager<T>;
/**
 * @internal
 *
