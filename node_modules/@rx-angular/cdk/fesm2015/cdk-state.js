...
import { Promise as Promise$1 } from '@rx-angular/cdk/zone-less';
import { from, combineLatest } from 'rxjs';
import { filter, distinctUntilChanged, map, shareReplay } from 'rxjs/operators';

const resolvedPromise = Promise$1.resolve();
...
export { accumulateObservables };
//# sourceMappingURL=cdk-state.js.map
