import { RxZoneGlobalDisableConfigurationsKey, RxZoneGlobalSettingsConfigurationsKey, RxZoneTestDisableConfigurationsKey, RxZoneTestSettingsConfigurationsKey, RxZoneGlobalEventsConfigurationsKey, RxZoneRuntimeConfigurationsKey } from './configurations.types';
export declare type RxGlobalDisableConfigurationMethods = {
    [disabledFlag in RxZoneGlobalDisableConfigurationsKey]: () => void;
} & {
    [symbolFlag in RxZoneGlobalSettingsConfigurationsKey]: () => void;
};
export declare type RxTestDisableConfigurationMethods = {
    [disabledFlag in RxZoneTestDisableConfigurationsKey]: () => void;
} & {
    [symbolFlag in RxZoneTestSettingsConfigurationsKey]: () => void;
};
export declare type RxZoneGlobalEventsConfigurationsMethods = {
    [disabledFlag in RxZoneGlobalEventsConfigurationsKey]: (eventNames: string[]) => void;
};
export declare type RxRuntimeConfigurationMethods = {
...
export declare type RxZoneConfig = RxZoneConfigConfiguration & RxZoneConfigConvenienceMethods;
