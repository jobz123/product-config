...
export declare type RxZoneGlobalDisableConfigurationsKey = keyof RxZoneGlobalDisableConfigurations;
export declare const zoneGlobalDisableConfigurationsKeys: RxZoneGlobalDisableConfigurationsKey[];
...
export declare type RxZoneGlobalEventsConfigurationsKey = keyof RxZoneGlobalEventsConfigurations;
export declare const zoneGlobalEventsConfigurationsKeys: RxZoneGlobalEventsConfigurationsKey[];
...
export declare type RxZoneGlobalSettingsConfigurationsKey = keyof RxZoneGlobalSettingsConfigurations;
export declare const zoneGlobalSettingsConfigurationsKeys: RxZoneGlobalSettingsConfigurationsKey[];
export interface RxZoneRuntimeConfigurations {
    ignoreConsoleErrorUncaughtError?: boolean;
}
export declare type RxZoneRuntimeConfigurationsKey = keyof RxZoneRuntimeConfigurations;
export declare const zoneRuntimeConfigurationsKeys: RxZoneRuntimeConfigurationsKey[];
...
export declare type RxZoneTestDisableConfigurationsKey = keyof RxZoneTestDisableConfigurations;
export declare const zoneTestDisableConfigurationsKeys: RxZoneTestDisableConfigurationsKey[];
...
export declare type RxZoneTestSettingsConfigurationsKey = keyof RxZoneTestSettingsConfigurations;
export declare const zoneTestSettingsConfigurationsKeys: RxZoneTestSettingsConfigurationsKey[];
