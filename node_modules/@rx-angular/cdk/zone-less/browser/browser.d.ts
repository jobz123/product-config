 ...
 */
export declare function queueMicrotask(): ((callback: VoidFunction) => void) & typeof globalThis.queueMicrotask;
 ...
 *
 */
export declare function setTimeout(cb: TimerHandler, ms?: number): number;
/**
 * clearTimeout
 *
 * @description
 ...
 * @param target
 */
export declare function unpatchAddEventListener<T extends EventTarget>(target: T): T;
