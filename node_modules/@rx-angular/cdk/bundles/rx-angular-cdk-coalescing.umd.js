(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@rx-angular/cdk/coalescing', ['exports', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['rx-angular'] = global['rx-angular'] || {}, global['rx-angular'].cdk = global['rx-angular'].cdk || {}, global['rx-angular'].cdk.coalescing = {}), global.rxjs));
    ...
    ***************************************************************************** */
    ...
    var ɵ0 = function (ctx) { return ({
        numCoalescingSubscribers: 0,
    }); };
    var coalescingContextPropertiesMap = createPropertiesWeakMap(ɵ0);
    /**
                ...
                return {
                    ...
                    next: function (value) {
                        ...
                        if (!actionSubscription) {
                            ...
                            rootSubscription.add(new rxjs.Subscription(function () {
                                tryEmitLatestValue();
                                actionSubscription === null || actionSubscription === void 0 ? void 0 : actionSubscription.unsubscribe();
                                actionSubscription = undefined;
                            }));
    ...
    exports.coalescingManager = coalescingManager;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=rx-angular-cdk-coalescing.umd.js.map
