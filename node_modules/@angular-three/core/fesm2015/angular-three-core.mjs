...
import { InjectionToken, inject, ElementRef, NgZone, Injectable, Inject, Directive, EventEmitter, Component, ChangeDetectionStrategy, Self, HostBinding, Input, Output, ViewChild, NgModule, Optional, ChangeDetectorRef, SkipSelf, Pipe, ViewContainerRef, TemplateRef, ContentChild } from '@angular/core';
import { __classPrivateFieldGet, __rest, __classPrivateFieldSet } from 'tslib';
...
import { Observable, Subject, pipe, debounceTime, takeUntil, fromEvent, share, ReplaySubject, noop, catchError, EMPTY, tap, map, defer, merge, take, mapTo, forkJoin, of, throwError } from 'rxjs';
...
function provideCanvasOptions(options) {
    return Object.assign(Object.assign({}, DEFAULT_NGT_CANVAS_OPTIONS), (options || {}));
}
        ...
        super((subscriber) => {
            ...
            ngZone.runOutsideAngular(() => {
                const callback = (entries) => {
                    ...
                    Object.freeze(size);
                    subscriber.next(Object.assign({ entries, dpr: document.defaultView.devicePixelRatio }, size));
...
class NgtStore extends EnhancedRxState {
    constructor(performance, { nativeElement: canvasHost }, resizeResult$) {
        ...
        this.connect('viewport', this.resizeResult$, ({ viewport }, { dpr }) => (Object.assign(Object.assign({}, viewport), { dpr })));
...
_NgtStore_allReady$ = new WeakMap(), _NgtStore_dimensions$ = new WeakMap(), _NgtStore_instances = new WeakSet(), _NgtStore_init = function _NgtStore_init(canvasElement) {
    ...
    if (!!(customRenderer === null || customRenderer === void 0 ? void 0 : customRenderer.render)) {
        this.set({
    ...
    const renderer = new THREE.WebGLRenderer(Object.assign({ powerPreference: 'high-performance', canvas: canvasElement, antialias: true, alpha: true }, (glOptions || {})));
    if (glOptions) {
...
class NgtAnimationFrameStore extends EnhancedRxState {
    ...
    register(animationRecord) {
        var _a;
        const uuid = ((_a = animationRecord.obj) === null || _a === void 0 ? void 0 : _a.uuid) || makeId();
        this.actions.animationRecord(Object.assign(Object.assign({}, animationRecord), { uuid }));
        return uuid;
    }
    ngOnDestroy() {
        this.set({ animations: {} });
...
_NgtAnimationFrameStore_instances = new WeakSet(), _NgtAnimationFrameStore_register = function _NgtAnimationFrameStore_register(_a = {
    uuid: '',
    callback: noop,
}) {
    var { uuid } = _a, animationRecord = __rest(_a, ["uuid"]);
    if (uuid) {
        this.set((state) => {
            return {
                animations: Object.assign(Object.assign({}, state.animations), { [uuid]: animationRecord }),
            };
        });
    }
    ...
    if (!uuid)
        return;
    this.set((state) => {
        const _a = state.animations, _b = uuid, _ = _a[_b], animations = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
        return { animations };
    });
};
...
class NgtLoopService {
    ...
    invalidate(state = this.store.get()) {
        var _a;
        if (state.vr) {
            (_a = state.renderer) === null || _a === void 0 ? void 0 : _a.setAnimationLoop((timestamp) => {
...
function createEvents(stateGetter, eventsStateGetter) {
    ...
    function prepareRay(event) {
        ...
        if (raycaster && camera) {
            const { offsetX, offsetY } = (_b = (_a = raycaster === null || raycaster === void 0 ? void 0 : raycaster.computeOffsets) === null || _a === void 0 ? void 0 : _a.call(raycaster, event, getRenderState(state))) !== null && _b !== void 0 ? _b : event;
            const { width, height } = size;
    ...
    function filterPointerEvents(objects) {
        return objects.filter((obj) => ['move', 'over', 'enter', 'out', 'leave'].some((name) => { var _a, _b; return (_b = (_a = obj.__ngt) === null || _a === void 0 ? void 0 : _a.handlers) === null || _b === void 0 ? void 0 : _b[('pointer' + name)]; }));
    }
    function intersect(filter) {
        ...
        if (!(raycaster === null || raycaster === void 0 ? void 0 : raycaster.enabled))
            return [];
        const seen = new Set();
        const intersections = [];
        ...
        for (const intersect of intersects) {
            ...
            // Bubble event up
            while (eventObject) {
                if ((_a = eventObject.__ngt) === null || _a === void 0 ? void 0 : _a.eventCount)
        ...
        if (intersections.length && camera) {
            ...
            for (const hit of intersections) {
                ...
                let raycastEvent = Object.assign(Object.assign(Object.assign({}, hit), extractEventProps), { spaceX: mouse.x, spaceY: mouse.y, intersections, stopped: localState.stopped, delta,
                    unprojectedPoint, ray: raycaster === null || raycaster === void 0 ? void 0 : raycaster.ray, camera: camera, 
    ...
    function objectPointerMissed(event, objects) {
        objects.forEach((object) => { var _a, _b, _c; return (_c = (_b = (_a = object.__ngt) === null || _a === void 0 ? void 0 : _a.handlers) === null || _b === void 0 ? void 0 : _b.pointermissed) === null || _c === void 0 ? void 0 : _c.call(_b, event); });
    }
...
class NgtEventsStore extends EnhancedRxState {
    ...
    addInteraction(interaction) {
        this.set((state) => (Object.assign(Object.assign({}, state), { internal: Object.assign(Object.assign({}, state.internal), { interaction: [...state.internal.interaction, interaction] }) })));
    }
    removeInteraction(uuid) {
        this.set((state) => (Object.assign(Object.assign({}, state), { internal: Object.assign(Object.assign({}, state.internal), { interaction: state.internal.interaction.filter((interaction) => interaction.uuid !== uuid) }) })));
    }
}
_NgtEventsStore_instances = new WeakSet(), _NgtEventsStore_connect = function _NgtEventsStore_connect(element) {
    return this.ngZone.runOutsideAngular(() => {
        ...
        Object.entries(handlers !== null && handlers !== void 0 ? handlers : {}).forEach(([eventName, handler]) => {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: NgtCanvas, decorators: [{
  ...
  `,
    ...
    `,
        ...
        return [{ type: NgtStore, decorators: [{
                        type: Self
...
_Controller_readyFn = new WeakMap(), _Controller_instances = new WeakSet(), _Controller_assignProps = function _Controller_assignProps() {
    this.ngZone.runOutsideAngular(() => {
        this.props.forEach((prop) => {
            ...
            selfController[prop] = (_a = selfController[prop]) !== null && _a !== void 0 ? _a : inputController[prop];
        });
    });
};
...
class NgtObject3dInputsController extends Controller {
    ...
    get object3dProps() {
        ...
        return {
            name: this.name,
            position: (_a = __classPrivateFieldGet(this, _NgtObject3dInputsController_position, "f")) === null || _a === void 0 ? void 0 : _a.toArray(),
            rotation: (_b = __classPrivateFieldGet(this, _NgtObject3dInputsController_rotation, "f")) === null || _b === void 0 ? void 0 : _b.toArray(),
            quaternion: (_c = __classPrivateFieldGet(this, _NgtObject3dInputsController_quaternion, "f")) === null || _c === void 0 ? void 0 : _c.toArray(),
            scale: (_d = __classPrivateFieldGet(this, _NgtObject3dInputsController_scale, "f")) === null || _d === void 0 ? void 0 : _d.toArray(),
            color: this.color,
                ...
                if (!this.disabled) {
                    const observedEvents = supportedEvents.reduce((result, event) => {
                        ...
                        const controllerEvent = this.objectInputsController[event]
                            ...
                            : ((_a = this.objectInputsController.object3dInputsController) === null || _a === void 0 ? void 0 : _a[event].observed)
                    ...
                    this.store.set((state) => (Object.assign(Object.assign({}, state), { objects: Object.assign(Object.assign({}, state.objects), { [this.object3d.uuid]: this.object3d }) })));
    ...
    ngOnDestroy() {
        ...
        if (this.object3d) {
            ...
            this.store.set((state) => {
                const _a = state.objects, _b = this.object3d.uuid, _ = _a[_b], objects = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
...
_NgtObject3dController_object3d = new WeakMap(), _NgtObject3dController_inputChangesSubscription = new WeakMap(), _NgtObject3dController_initFn = new WeakMap(), _NgtObject3dController_change$ = new WeakMap(), _NgtObject3dController_instances = new WeakSet(), _NgtObject3dController_objectReady = function _NgtObject3dController_objectReady() {
    ...
    this.ngZone.runOutsideAngular(() => {
        ...
        (_b = (_a = this.object3d).updateMatrix) === null || _b === void 0 ? void 0 : _b.call(_a);
    });
};
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: NgtObject3dController, decorators: [{
  ...
  `,
        ...
        return [{ type: i0.NgZone }, { type: NgtStore }, { type: NgtEventsStore }, { type: NgtObject3dInputsController, decorators: [{
                        type: Inject,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: NgtCursor, decorators: [{
        ...
        return [{ type: NgtObject3dInputsController, decorators: [{
                        type: Optional
                    }, {
                        type: Self
                    }] }, { type: Document, decorators: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: NgtMaterialGeometryController, decorators: [{
  ...
  `,
        ...
        return [{ type: i0.NgZone }, { type: NgtObject3dController, decorators: [{
                        type: Inject,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: NgtCommonAudio, decorators: [{
        ...
        return [{ type: NgtObject3dController, decorators: [{
                        type: Inject,
                        args: [NGT_OBJECT_WATCHED_CONTROLLER]
                    }] }, { type: i0.NgZone }];
...
class NgtCommonLine {
    ...
    get line() {
        var _a;
        return (_a = this.materialGeometryController) === null || _a === void 0 ? void 0 : _a.objectController.object3d;
    }
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: NgtCommonLine, decorators: [{
        ...
        return [{ type: NgtMaterialGeometryController, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: NgtAttribute, decorators: [{
        ...
        return [{ type: i0.NgZone }, { type: NgtGeometry, decorators: [{
                        type: Optional
                    }] }];
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: NgtMaterial, decorators: [{
        ...
        return [{ type: i0.NgZone }, { type: NgtStore }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [NGT_OBJECT_3D]
                    }] }, { type: NgtContentMaterialController, decorators: [{
                        type: Optional
...
const NGT_IS_WEBGL_AVAILABLE = new InjectionToken('isWebGLAvailable', {
    ...
    factory: () => {
        ...
        try {
            ...
            return !!(((_a = document.defaultView) === null || _a === void 0 ? void 0 : _a.WebGL2RenderingContext) &&
