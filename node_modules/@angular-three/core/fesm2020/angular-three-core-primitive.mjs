...
import { NGT_OBJECT_WATCHED_CONTROLLER, NGT_OBJECT_CONTROLLER_PROVIDER, NgtObject3dControllerModule } from '@angular-three/core';
import * as i0 from '@angular/core';
import { EventEmitter, Directive, Inject, Output, Input, NgModule } from '@angular/core';
...
export { NgtPrimitive, NgtPrimitiveModule };
//# sourceMappingURL=angular-three-core-primitive.mjs.map
